				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="dropdown main-header-notification flag-dropdown">
							...
							<div class="dropdown-menu">
								<a href="#" class="dropdown-item d-flex ">
									<span class="avatar  mr-3 align-self-center bg-transparent"><img src="https://cdn.britannica.com/70/2970-004-717C4223/Flag-Nepal.jpg" alt="img"></span>
									<div class="d-flex">
										<span class="mt-2">Nepali</span>
									</div>
								</a>
							</div>
						</div>
						...
						<div class="dropdown main-profile-menu">
							<a class="d-flex" href="">
								<span class="main-img-user" ><img alt="avatar" src="{{asset('assets/img/brand/avatar.png')}}"></span>
							</a>
							<div class="dropdown-menu">
								<div class="header-navheading">
									<h6 class="main-notification-title">{{request()->user()->name ?? "Bikash Subedi"}}</h6>
									<p class="main-notification-text">Developer</p>
								</div>
